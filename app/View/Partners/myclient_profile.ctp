					...
					<tbody>
						...
						<tr>
							<td>
								...
								<a class="btn btn-mini" href="<?php echo SITE_URL;?>Partners/mynetwork_history/process:<?php echo $acc['Mt4User']['LOGIN'];?>/siapa:<?php echo $var['User']['username'];?>" >
					...
					<tbody>
						...
						<tr>
							<td>
								...
								<a class="btn btn-mini" href="<?php echo SITE_URL;?>Partners/myagent_history/process:<?php echo $acc['Mt4User']['LOGIN'];?>/siapa:<?php echo $var['User']['username'];?>" >
									<?php echo $acc['Mt4User']['LOGIN'];?>
								</a>
							</td>
							<td><?php echo number_format($acc['Mt4User']['BALANCE'], 2, '.', '');?></td>
