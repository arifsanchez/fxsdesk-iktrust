	...
	<div class="span12">
		<div class="box box-color satgreen box-bordered" id="updateTradeHistory">
			<div class="box-title">
				...
				<div class="actions">
					<a href="<?php echo SITE_URL;?>Partners/vault?me:<?php echo $var['User']['username'];?>" class="btn btn-mini" rel="tooltip" title="Partner Vault Overview"><i class="icon-money"></i> Back to partner vault overview</a>
				</div>
			</div>
			<div class="box-content nopadding">
				...
				<table class="table table-hover table-nomargin table-condensed table-bordered">
					<thead>
						<?php if(empty($Wtransact)){ echo "<tr><blockquote>Your IK Wallet account is fresh without any transaction. Start earning great rewards today . Contact your account manager to find out more.</blockquote></tr>";} else {?> 
						<tr>
							<th>Reference Key</th>
							<th>Type</th>
							<th>Status</th>
