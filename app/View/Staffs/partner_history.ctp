...
<div class="row-fluid">
	<div class="span12">
		<div class="box box-color satblue box-bordered" id="updateTradeHistory">
			<div class="row-fluid">
				<div id="accordion3" class="accordion accordion-widget">
					<div class="accordion-group blue">
						<div class="accordion-heading">
							<a href="#c1" data-parent="#accordion3" data-toggle="collapse" class="accordion-toggle collapsed"><?php echo $nama_agent;?>
							</a>
						</div>
						<div class="accordion-body collapse" id="c1" style="height: 0px;">
					...
					<div class="accordion-group">
						<div class="accordion-heading">
							<a href="#c2" data-parent="#accordion3" data-toggle="collapse" class="accordion-toggle">
								Trading Accounts Refferred
							</a>
						</div>
						<div class="accordion-body collapse" id="c2" style="height: 0px;">
							<div class="accordion-inner">
