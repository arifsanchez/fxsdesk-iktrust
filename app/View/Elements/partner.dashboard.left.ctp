		...
		<div class="pagestats">
			...
			<span class="left">
				<a
					...
					class="btn" 
					href="<?php echo SITE_URL;?>TraderAccounts/myclient?me:<?php echo $var['User']['username'];?>"
					title="" 
					data-trigger="hover" 
					data-toggle="modal"	
				>
		...
		<div class="pagestats">
			...
			<span class="left">
				<a
						...
						data-placement="bottom"
						class="btn" 
						href="<?php echo SITE_URL;?>TraderAccounts/mynetwork?me:<?php echo $var['User']['username'];?>"
						title="" 
						data-trigger="hover" 
						data-toggle="modal"	
					>
		...
		<div class="pagestats">
			...
			<span class="left">
				<a
					...
					data-placement="bottom"
					class="btn" 
					href="<?php echo SITE_URL;?>TraderAccounts/myagent?me:<?php echo $var['User']['username'];?>"
					title="" 
					data-trigger="hover" 
					data-toggle="modal"	
				>
