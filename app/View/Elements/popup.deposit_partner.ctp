<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal hide fade" id="DepositWallet_partner" style="display: none;">
	<div class="modal-header">
		<button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
		<h3 id="myModalLabel"><i class="icon-money"></i> Deposit to Wallet
			<span class="pull-right">
				<button class="btn btn-success" disabled><b><?php echo $this->Number->Currency($bal, 'IK$ '); ?></b></button>&nbsp;
			</span>
		</h3>
	</div>
