<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="1" class="modal hide fade" id="WDpartnerAcc<?php echo $login;?>" style="display: none;">
	...
	<div class="row-fluid">
		...
		<div class="span7">
			<?php
				...
				echo $this->Form->input('amount', array(
					...
					'placeholder' => 'Max '.$this->Number->Currency($balance, 'US$ '),
					'class' => 'input-medium',
					'div' => false,
		...
		<div class="span5">
			<?php 
				...
				echo "<blockquote>Partner Vault balance <br/><span class='label label-satblue'>". $this->Number->Currency($bal, 'US$ ')."</span></blockquote>";
			?>
		</div>
