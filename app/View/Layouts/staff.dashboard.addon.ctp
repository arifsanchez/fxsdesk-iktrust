...
<head>
	...
	#JS
		...
		/* Datatable */
		echo $this->Html->script('plugins/datatable/jquery.dataTables.min.js?q='.QRDN);
		echo $this->Html->script('plugins/datatable/TableTools.min.js?q='.QRDN);
		echo $this->Html->script('plugins/datatable/ColReorderWithResize.js?q='.QRDN);
		echo $this->Html->script('plugins/datatable/ColVis.min.js?q='.QRDN);
		echo $this->Html->script('plugins/datatable/jquery.dataTables.columnFilter.js?q='.QRDN);
		echo $this->Html->script('plugins/datatable/jquery.dataTables.grouping.js?q='.QRDN);
