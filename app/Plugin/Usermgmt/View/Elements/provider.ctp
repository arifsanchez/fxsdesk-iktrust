...
<div class="providerBox test3">
	<ul class="providers minitiles">
		<?php if(USE_FB_LOGIN){ ?>
		<li id="facebook" class="blue" title='<?php echo __('Facebook Connect');?>' onclick="javascript:login_popup('fb');return false;">
			<a 
				href="#"
				data-original-title="Sign In / Register using Facebook."
		...
		<li id="google" class="red" title='<?php echo __('Gmail Connect');?>' onclick="javascript:login_popup('gmail');return false;">
			<a 
				href="#"
				data-original-title="Sign In / Register using Google Account (Gmail)."
				data-placement="bottom"
				title="" 
				data-toggle="modal" 
				data-trigger="hover"  
		...
		<li id="yahoo" class="magenta" title='<?php echo __('Yahoo Connect');?>' onclick="javascript:login_popup('yahoo');return false;">
			<a 
				href="#"
				data-original-title="Sign In / Register using Yahoo Mail."
				data-placement="bottom"
				title="" 
				data-toggle="modal" 
				data-trigger="hover"  
