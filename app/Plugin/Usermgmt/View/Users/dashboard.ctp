<div class="row-fluid">
	<div class="span12">
		<ul class="tiles">
			...
			<li class="red">
				<a href="<?php echo SITE_URL;?>securityInbox"><span class='count'><i class="icon-envelope"></i></span><span class='name'>Security Mail</span></a>
			</li>
			<li class="darkblue">
				<a href="<?php echo SITE_URL;?>pages/downloads"><span><i class="glyphicon-download"></i></span><span class='name'>Downloads</span></a>
			</li>
			<li class="teal long">
				<a href="<?php echo SITE_URL;?>pages/trading-conditions"><span class='count'><i class="icon-book"></i></span><span class='name'>Trading Conditions</span></a>
			</li>
			<li class="orange">
