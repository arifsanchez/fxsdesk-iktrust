<div class="row-fluid">
	<div class="span12">
		<ul class="tiles">
			...
			<li class="grey long">
				<a href="<?php echo SITE_URL;?>TraderAccounts/affilliate"><span class='count'><i class="glyphicon-wallet"></i><span class='name'>Affilliate Accounts</span></a>
			</li>
			...
			<li class="brown">
				<a href="<?php echo SITE_URL;?>Traders/verifyIdentity"><span><i class="icon-cloud-upload"></i></span><span class='name'>Verification</span></a>
			</li>
			<li class="satblue">
			...
			<li class="teal">
				<a href="<?php echo SITE_URL;?>contents/trading_conditions"><span class='count'><i class="icon-book"></i></span><span class='name'>TradeBook</span></a>
			</li>
			<li class="orange">
